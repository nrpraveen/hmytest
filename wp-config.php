...
define('HOSTNAME_LOCAL','localhost');
define('HOSTNAME_DEV','test.nrdomain.com.php72-4.lan3-1.websitetestlink.com/');
define('HOSTNAME_LIVE','test.nrdomain.com.php72-4.lan3-1.websitetestlink.com/');
...
if(in_array($_SERVER['HTTP_HOST'], [HOSTNAME_LOCAL, HOSTNAME_DEV])) {
	$hostname = $_SERVER['REMOTE_ADDR'] == '127.0.0.1' ? '207.246.248.12' : 'localhost';
	$database = 'hmytest';
	$username = 'root';
	$password = 'password';
}
...
define('DB_COLLATE', '');
define('WP_SITEURL', $protocol.'://'.$_SERVER['HTTP_HOST'].'/hmytest');
define('WP_HOME', $protocol.'://'.$_SERVER['HTTP_HOST'].'/hmytest');
